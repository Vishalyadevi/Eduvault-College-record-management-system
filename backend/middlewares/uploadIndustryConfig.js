...
const industryDir = path.join(__dirname, '../uploads/industry');
...
const storage = multer.diskStorage({
  ...
  filename: function (req, file, cb) {
    ...
    cb(null, `industry-${userId}-${uniqueSuffix}-${sanitizedOriginalName}`);
  }
});
...
// Multer field for industry certificate
export const uploadIndustryFile = upload.single('certificate_pdf');
