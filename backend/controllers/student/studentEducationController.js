...
export const addOrUpdateEducationRecord = async (req, res) => {
  try {
    ...
    const payload = {
      ...
      tenth_year_of_passing: sanitizeInt(tenth_year_of_passing || req.body.tenth_year || req.body.tenth_passing_year),
      ...
      twelfth_year_of_passing: sanitizeInt(twelfth_year_of_passing || req.body.twelfth_year || req.body.twelfth_passing_year),
