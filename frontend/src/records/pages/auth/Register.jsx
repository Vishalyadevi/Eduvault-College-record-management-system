    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        <input
          ...
          required={required}
          className="w-full pl-12 pr-4 py-3.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-600 transition-all bg-gray-50 focus:bg-white"
        />
      </div>
    </div>
  );
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-indigo-50 to-indigo-50 flex items-center justify-center p-8">
      <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8 border border-white/50 w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-indigo-600 to-indigo-600 rounded-full mb-4 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full py-3.5 px-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-600 transition-all bg-gray-50 focus:bg-white"
            >
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-indigo-600 to-indigo-600 text-white py-3.5 rounded-xl font-semibold hover:from-indigo-700 hover:to-indigo-700 focus:ring-4 focus:ring-indigo-300 transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center"
          >
            {isLoading ? (
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600">
            ...
            <button
              ...
              className="text-indigo-600 hover:text-blue-800 font-semibold hover:underline"
            >
              Sign in here
            </button>
          </p>
