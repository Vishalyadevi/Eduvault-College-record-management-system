...
const Login = () => {
    ...
    // NOTE: Login page should always be accessible - no redirect logic
    // This allows users to see the login page and log in as a different user if needed
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response && response.success) {
                // Get role and redirect after successful login
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                autoComplete="email"
                                required
                                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-600 focus:z-10 sm:text-sm"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-600 focus:z-10 sm:text-sm"
