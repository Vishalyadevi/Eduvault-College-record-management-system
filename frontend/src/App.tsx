...
import BreakOfStudy from './records/pages/admin/BreakOfStudy.jsx';
...
const AppRoutes: React.FC = () => {
  return (
    <Routes>
      ...
      <Route path="/records/break-of-study" element={
        <ProtectedRoute allowedRoles={['Superadmin', 'Deptadmin', 'acadamicadmin', 'Admin', 'Staff']}>
          <RecordsLayoutWithLocation><BreakOfStudy /></RecordsLayoutWithLocation>
        </ProtectedRoute>
      } />
