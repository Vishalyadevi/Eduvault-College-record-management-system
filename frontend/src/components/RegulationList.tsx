...
const regulations = [
  { label: "UG Regulation -2023", url: "/pdfs/ug-regulation-2023.pdf" },
  { label: "PG Regulation -2023", url: "/pdfs/pg-regulation-2023.pdf" },
  { label: "UG Regulation -2019", url: "/pdfs/ug-regulation-2019.pdf" },
  { label: "PG Regulation -2019", url: "/pdfs/pg-regulation-2019.pdf" },
];
...
const RegulationList = () => {
  return (
    <div className="bg-gray-50 min-h-2 ">
        ...
        <h1 className="fee-title">UG/PG REGULATIONS</h1>
      </div><br></br>
      <div className="space-y-4 ml-[10%]">
        {regulations.map((item, index) => (
          <a
            ...
            className="flex items-center text-blue-600 font-semibold text-lg hover:text-black hover:border hover:border-black px-3 py-2 rounded transition-all w-fit"
          >
            <OrangeTickIcon />&nbsp;&nbsp;&nbsp;&nbsp;
            {item.label}
            <svg 
