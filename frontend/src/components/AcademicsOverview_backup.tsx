...
import { BookOpen, Users, Award, Building2, GraduationCap, X, GraduationCap as DeanIcon } from 'lucide-react';
      ...
      <header className="bg-blue-900 text-white py-6 fixed top-0 left-0 w-full z-20">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <DeanIcon className="h-8 w-8" />
            <h1 className="text-2xl font-bold">Academic Dean's Office</h1>
          </div>
        </div>
      </header>
      <div className="pt-24">
        ...
        >
          ...
          <div className="relative container mx-auto px-4 h-full flex flex-col justify-center">
            <div className="max-w-3xl">
              <h2 className="text-5xl font-bold text-white mb-6">Office of the Dean</h2>
