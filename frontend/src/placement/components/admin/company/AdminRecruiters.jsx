                  ...
                  company && company.companyName ? (
                    <tr key={company.id || index} className="border-b hover:bg-gray-50">
                      ...
                      <td className="px-4 py-2 flex gap-2">
                        <button
                          className="bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600 transition shadow-sm"
                          onClick={(e) => handleEdit(company, e)}
                        >
                          Edit
                        </button>
                        <button
                          className="bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600 transition shadow-sm"
